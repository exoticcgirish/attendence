...
# --- Database Names ---
MAIN_AUTH_DB_NAME = "main_auth_db"  # Stores all teacher login credentials
SCHOOL_DB_NAME = "school_db"        # Stores ALL students and attendance records
...
# This dependency provides the main client to our endpoints
